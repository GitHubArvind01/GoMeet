...
// //     try {
// //       const res = await axios.post(API_BASE_URL+"/meeting/schedule", payload);
...
//   const handleConfirmYes = () => { clearForm(); setShowConfirm(false); };
...
//           <div
//             key={notif.id}
//             className={`px-4 py-2 rounded shadow-md text-white max-w-xs break-words ${
...
//             <div className="flex items-center gap-2">
//               <label className="font-medium">FROM:</label>
//               <input type="date" className="bg-white border-none rounded px-2 py-1" value={fromDate} onChange={(e) => setFromDate(e.target.value)} />
//               <input type="time" className="bg-white border-none rounded px-2 py-1" value={fromTime} onChange={(e) => setFromTime(e.target.value)} />
//             </div>
//             <div className="flex items-center gap-2">
//               <label className="font-medium">TO:</label>
//               <input type="date" className="bg-white border-none rounded px-2 py-1" value={toDate} onChange={(e) => setToDate(e.target.value)} />
//               <input type="time" className="bg-white border-none rounded px-2 py-1" value={toTime} onChange={(e) => setToTime(e.target.value)} />
//             </div>
//           </div>

//           <div className="flex gap-4">
//             <button className="border-none bg-blue-600 text-white px-6 py-2 rounded" onClick={handleSaveClick}>Save</button>
//             <button className="border-none bg-white border-black px-6 py-2 rounded" onClick={handleCancelClick}>Cancel</button>
//           </div>
//         </div>
...
//               <button className="bg-red-500 text-white px-4 py-2 rounded" onClick={handleConfirmYes}>Yes</button>
//               <button className="bg-gray-300 text-black px-4 py-2 rounded" onClick={handleConfirmNo}>No</button>
//             </div>
//           </div>
//         </div>
//       )}
